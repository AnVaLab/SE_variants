...
awk '$(NF-1)=="SE" {print $0}' /home/avasileva/project/monocytes/combined_annotation/te_se_e.bed > /home/avasileva/project/monocytes/se/se_e.bed;
awk '$(NF-1)!="SE" {print $0}' /home/avasileva/project/monocytes/combined_annotation/te_se_e.bed > /home/avasileva/project/monocytes/enhancers/te.bed;
